...
<html lang="en">
   ...
   <body>
      ...
      <p>Has recibido una oferta de servicio especial de transporte en <a href="${url_ayax}">Ayax.co</a> por un valor de COP$${oferta.valorTotal}.</p>
      <p>Por favor, ten en cuenta que el transportador solo garantiza disponibilidad para el servicio hasta 24 horas despu&eacute;s del envio de la presente oferta. Por 
         lo que si decides contratarle despu&eacute;s de 24 horas existe la posibilidad de que el transportador no est&eacute; disponible.
      </p>
      <p>&nbsp;</p>
