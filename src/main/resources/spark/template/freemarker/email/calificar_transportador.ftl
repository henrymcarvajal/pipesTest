...
<html lang="en">
    ...
    <body>
        ...
        <p>Es hora de calificar el servicio de transportador.</p>
        <p>&nbsp;</p>
        <p>Haz clic <a href="${url_ayax}/calificarTransportador.html?id=${oferta.id}&rol=0">aqu&iacute;</a> para dar tu calificaci&oacute;n.</p>
        <p>&nbsp;</p>
        <p>Cordialmente,</p>
        <p>&nbsp;</p>
