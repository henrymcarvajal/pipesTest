...
<html lang="es">
    <head>
        ...
        <title>Consigue transporte de pasajeros en Vans, buses y camionetas-Ayax</title>

        <!-- Bootstrap -->
        <link href="css/bootstrap.min.css" rel="stylesheet">
		<meta name="description" content="Cotiza y consigue transporte de pasajeros en Vans, buses y camionetas para los clientes o el personal de tu empresa o viaje particular">
    ...
    <header data-spy="affix" data-offset-top="39" data-offset-bottom="0" class="large">
        ...
        <div class="row container box">
            <div class="col-md-5">
                <!-- Logo start -->
                <div class="brand">
                    <h2><a class="scroll-to" href="#top"><img class="img-responsive" src="img/logo.png" alt="Transporte de pasajeros"></a></h2>
                </div>
                <!-- Logo end -->
            </div>
                    ...
                    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <h1 class="title">Consigue el transporte que necesitas
                                    <span class="subtitle">Vans, buses y camionetas. Para tu viaje empresarial, personal o particular</span></h1>
                                <div class="car-img">
                                    <img src="img/car1.png" class="img-responsive" alt="transporte de pasajeros, buses, vans">
                                </div>
                            </div>
                            <div class="item">
                                <h2 class="title">Te conectamos directamente con los transportadores
                                    <span class="subtitle">Ahorra hasta un 30%</span></h2>
                                <div class="car-img">
                                    <img src="img/car2.png" class="img-responsive" alt="transporte de pasajeros, buses, vans">
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-5 col-xs-12 pull-left">
                    <div class="reservation-form-shadow">
                        ...
                        <form action="#" method="post" name="car-select-form" id="car-select-form">
                            ...
                            <div class="datetime pick-up">
                                <div class="date pull-left">
                                    <div class="input-group">
                                        <span class="input-group-addon pixelfix"><span class="glyphicon glyphicon-user"></span>Número Pasajeros</span>
                                        
                                    </div>
                                </div>
								<div class="time pull-right">
                                        <input type="number" id="car-select" placeholder="Pasajeros"/>
                                </div>
                            </div>
                            <div class="datetime pick-up">
                                <div class="date pull-left">
                            ...
                            <input type="submit" class="submit" name="submit" value="Cotizar transporte" id="checkoutModalLabel">
                        </form>
